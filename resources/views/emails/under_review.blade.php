...
@if ($status === 'pending')
    <p>Thank you for registering with our platform. Your doctor account is currently <strong>under review</strong> by our administration team.</p>
...
@elseif ($status === 'accepted')
    ...
    <div style="text-align: center; margin: 20px 0;">
        <a href="{{ route('login') }}" style="background-color: #2ecc71; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
            Access Your Account
        </a>
    </div>
